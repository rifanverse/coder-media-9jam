...
const Footer = () => {
  return (
    <footer className="bg-gray-900">
        ...
        <div className="grid md:grid-cols-3 gap-7">
          <div className="">
            ...
            <p className="text-gray-400">
              ...
              debitis tempore voluptas neque quia natus.
            </p>
          </div>
          <div className="">
      ...
      <div className="max-w-screen-xl mx-auto px-4 border-t border-y-gray-500 py-8 text-center text-base text-gray-500">
        &copy; Copyright 2025 | Rifan | All Right Reserved
      </div>
    </footer>
  )
}
