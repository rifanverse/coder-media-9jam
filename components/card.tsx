...
const Card = () => {
  return (
    <div className="bg-white shadows-lg rounded-sm  transition duration-100 hover:shadow-sm ">
      <div className="h-[260px] w-auto rounded-t-sm realtive">
        <Image
          src="/hero.jpg"
          width={384}
          height={256}
      ...
      <div className="p-8">
        <h4 className="text-2xl font-medium">
          <Link
            href="#"
            className="hover:text-gray-800 transition duraiton-150"
          >
            Luxury Room
          </Link>
        </h4>
